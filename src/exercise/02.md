...
Memoization is a form of caching where react stores the computation foa a given
input, and returns the stored value when this same input is provided. This
prevents to recompute twice for the same input.
